...
import com.suixin.anomicon.core.data.AndroidArchiveAssetStore
...
class MainActivity : ComponentActivity() {
    ...
    private val archiveAssetStore by lazy { AndroidArchiveAssetStore(this) }
        ...
        setContent {
            AnomiconApp(
                repository = AnomiconRepository(
                    ...
                    archiveAssetStore = archiveAssetStore
                ),
